...
Status = 'المطور'
elseif DevelopersQ then
Status = Redis:get(black.."black:Developer:Bot:Reply"..ChatId) or 'المطور الثانوي'
...
return {
Lock     = '[. ‹ 𝖻𝗅𝖺𝖼𝗄 𝖳𝖾𝖺𝗆 . ](https://t.me/JFFFFF)\n*⋆┄┄─┄─┄─┄┄─┄─┄┄⋆\n‹ : بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n‹ : خاصيه المسح *',
unLock   = '[. ‹ 𝖻𝗅𝖺𝖼𝗄 𝖳𝖾𝖺𝗆 . ](https://t.me/JFFFFF)\n*⋆┄┄─┄─┄─┄┄─┄─┄┄⋆\n‹ : بواسطه ← *'..UserInfousername..'\n'..TextMsg,
lockKtm  = '[. ‹ 𝖻𝗅𝖺𝖼𝗄 𝖳𝖾𝖺𝗆 . ](https://t.me/JFFFFF)\n*⋆┄┄─┄─┄─┄┄─┄─┄┄⋆\n‹ : بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n‹ : خاصيه الكتم *',
lockKid  = '[. ‹ 𝖻𝗅𝖺𝖼𝗄 𝖳𝖾𝖺𝗆 . ](https://t.me/JFFFFF)\n*⋆┄┄─┄─┄─┄┄─┄─┄┄⋆\n‹ : بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n‹ : خاصيه التقييد *',
lockKick = '[. ‹ 𝖻𝗅𝖺𝖼𝗄 𝖳𝖾𝖺𝗆 . ](https://t.me/JFFFFF)\n*⋆┄┄─┄─┄─┄┄─┄─┄┄⋆\n‹ : بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n‹ : خاصيه الطرد *',
Reply    = '[. ‹ 𝖻𝗅𝖺𝖼𝗄 𝖳𝖾𝖺𝗆 . ](https://t.me/JFFFFF)\n*⋆┄┄─┄─┄─┄┄─┄─┄┄⋆\n🔰 : المستخدم⇷ *'..UserInfousername..'\n*'..TextMsg..'*'
}
end
...
print(Redis:get(black.."chadmin"..msg_chat_id))
print(data.sender.chat_id)
if data.sender.chat_id ~= Redis:get(black.."chadmin"..msg_chat_id) then
...
elseif tonumber(msg.sender.user_id) == 798700870 then
...
local N = (Redis:get(black.."Name:Bot") or "الروكس")
...
Redis:set(black..':toob:Name:'..msg.sender.user_id,NameLUser)
end
end
...
{
{text = '. ‹ 𝖻𝗅𝖺𝖼𝗄 𝖳𝖾𝖺𝗆 . ', url='https://t.me/JFFFFF'},
},
}
}
...
NamesBot = (Redis:get(black.."black:Name:Bot") or "الروكس")
...
{
{text = Jabwa, url = 'https://t.me/X_GGX'}, 
},
{
{text = Grosupsw, url = 'https://t.me/JFFFFF'}, 
},
{
{text = Usperos, url = 'https://t.me/JFFFFF'}, 
},
}
...
if UserInfo.first_name ~= "" then
Redis:sadd(black.."black:TheBasicsQ:Group"..msg_chat_id,v.member_id.user_id) 
end
end
end
Redis:sadd(black.."black:TheBasicsQ:Group"..msg_chat_id,msg.sender.user_id) 
...
{
{text = ' ❲ ‹ 𝖲𝗈𝗎𝗋𝖼𝖾 𝖻𝗅𝖺𝖼𝗄 . ❳ ',url="https://t.me/JFFFFF"}
},
}
}
...
if Redis:get(black.."lockalllll"..msg_chat_id) == "on" then
if not msg.Addictive then
...
Redis:del(black..'Abs:gif:Abs'..msg.chat_id) 
end
...
local F333F = ' \n‹ : تم تعطيل المتحركه'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(black..'Abs:gif:Abs'..msg.chat_id,true)  
end
if text and (text == "متحركه" or text == "↫ متحركه ✯") and not Redis:get(black..'Abs:gif:Abs'..msg.chat_id) then
...
local F333F = ' \n‹ : تم تفعيل الميمز'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:del(black..'Abs:memz:Abs'..msg.chat_id) 
end
...
local F333F = ' \n‹ : تم تعطيل الميمز'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(black..'Abs:memz:Abs'..msg.chat_id,true)  
end
if text and (text == "ميمز" or text == "↫ ميمز ✯") and not Redis:get(black..'Abs:memz:Abs'..msg.chat_id) then
...
local F333F = ' \n‹ : تم تفعيل الريمكس'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:del(black..'Abs:Remix:Abs'..msg.chat_id) 
end
...
local F333F = ' \n‹ : تم تعطيل الريمكس'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(black..'Abs:Remix:Abs'..msg.chat_id,true)  
end
...
local F333F = ' \n‹ : تم تفعيل الصوره'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:del(black..'Abs:Photo:Abs'..msg.chat_id) 
end
...
local F333F = ' \n‹ : تم تعطيل الصوره'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(black..'Abs:Photo:Abs'..msg.chat_id,true)  
end
if text and (text == "صوره" or text == "↫ صوره ✯") and not Redis:get(black..'Abs:Photo:Abs'..msg.chat_id) then
...
local F333F = ' \n‹ : تم تفعيل الانمي'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:del(black..'Abs:Anime:Abs'..msg.chat_id) 
end
...
local F333F = ' \n‹ : تم تعطيل الانمي'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(black..'Abs:Anime:Abs'..msg.chat_id,true)  
end
if text and (text == "انمي" or text == "↫ انمي ✯") and not Redis:get(black..'Abs:Anime:Abs'..msg.chat_id) then
...
local F333F = ' \n‹ : تم تفعيل الافلام'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:del(black..'Abs:Movies:Abs'..msg.chat_id) 
end
...
local F333F = ' \n‹ : تم تعطيل الافلام'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(black..'Abs:Movies:Abs'..msg.chat_id,true)  
end
if text and (text == "فلم" or text == "↫ فلم ✯") and not Redis:get(black..'Abs:Movies:Abs'..msg.chat_id) then
...
local F333F = ' \n‹ : تم تفعيل المسلسلات'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:del(black..'Abs:Series:Abs'..msg.chat_id) 
end
...
local F333F = ' \n‹ : تم تعطيل المسلسلات'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(black..'Abs:Series:Abs'..msg.chat_id,true)  
end
if text and (text == "مسلسل" or text == "↫ مسلسل ✯") and not Redis:get(black..'Abs:Series:Abs'..msg.chat_id) then
...
if text == 'بايو' and not Redis:get(black..'idnotmembio'..msg.chat_id)  then
...
if Redis:get(black..'idnotmembio'..msg.chat_id)  then
LuaTele.sendText(msg_chat_id,msg_id, '‹ : تم تعطيل امر البايو مسبقا\n ✓',"md")
else
Redis:set(black.."idnotmembio"..msg.chat_id,"true")
...
if not Redis:get(black..'idnotmembio'..msg.chat_id)  then
LuaTele.sendText(msg_chat_id,msg_id, '‹ : تم تفعيل امر البايو مسبقا\n ✓',"md")
else
Redis:del(black.."idnotmembio"..msg.chat_id)
...
if Redis:get(black..":"..msg.sender.user_id..":lov_Bots"..msg.chat_id) == "sendlove" then
...
Redis:del(black..":"..msg.sender.user_id..":lov_Bots"..msg.chat_id)
end
if Redis:get(black..":"..msg.sender.user_id..":lov_Bottts"..msg.chat_id) == "sendlove" then
num = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","😁 98","😀 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnum = num[math.random(#num)]
local tttttt = '‹ : اليك النتائج الخـاصة :\n\n‹ : نسبة الغباء  : *'..text..'* '..sendnum..'%'
LuaTele.sendText(msg_chat_id,msg_id,tttttt) 
Redis:del(black..":"..msg.sender.user_id..":lov_Bottts"..msg.chat_id)
end
if Redis:get(black..":"..msg.sender.user_id..":lov_Botttuus"..msg.chat_id) == "sendlove" then
num = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","😁 98","😀 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnum = num[math.random(#num)]
local tttttt = '‹ : اليك النتائج الخـاصة :\n\n‹ : نسبة الذكاء  : *'..text..'* '..sendnum..'%'
LuaTele.sendText(msg_chat_id,msg_id,tttttt) 
Redis:del(black..":"..msg.sender.user_id..":lov_Botttuus"..msg.chat_id)
end
if text and Redis:get(black..":"..msg.sender.user_id..":krh_Bots"..msg.chat_id) == "sendkrhe" then
num = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","😁 98","😀 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnum = num[math.random(#num)]
local tttttt = '⌯ اليك النتائج الخـاصة :\n\n⌯ نسبه الكرة : *'..text..'* '..sendnum..'%'
LuaTele.sendText(msg_chat_id,msg_id,tttttt) 
Redis:del(black..":"..msg.sender.user_id..":krh_Bots"..msg.chat_id)
end
if text and text ~="نسبه الرجوله" and Redis:get(black..":"..msg.sender.user_id..":rjo_Bots"..msg.chat_id) == "sendrjoe" then
numj = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","😁 98","🥰 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnuj = numj[math.random(#numj)]
local tttttt = '‹ : اليك النتائج الخـاصة :\n\n‹ : نسبة الرجوله لـ : *'..text..'* '..sendnuj..'%'
LuaTele.sendText(msg_chat_id,msg_id,tttttt) 
Redis:del(black..":"..msg.sender.user_id..":rjo_Bots"..msg.chat_id)
end
if text and text ~="نسبه الانوثه" and Redis:get(black..":"..msg.sender.user_id..":ano_Bots"..msg.chat_id) == "sendanoe" then
numj = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","?? 98","😀 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnuj = numj[math.random(#numj)]
local tttttt = '‹ : اليك النتائج الخـاصة :\n\n‹ : نسبه الانوثة لـ : *'..text..'* '..sendnuj..'%'
LuaTele.sendText(msg_chat_id,msg_id,tttttt) 
Redis:del(black..":"..msg.sender.user_id..":ano_Bots"..msg.chat_id)
end

if text == "نسبه الحب" or text == "نسبه حب" and msg.reply_to_message_id ~= 0 then
if not Redis:get(black.."AlNsb"..msg.chat_id) then    
Redis:set(black..":"..msg.sender.user_id..":lov_Bots"..msg.chat_id,"sendlove")
...
if not Redis:get(black.."AlNsb"..msg.chat_id) then    
Redis:set(black..":"..msg.sender.user_id..":lov_Bottts"..msg.chat_id,"sendlove")
...
if not Redis:get(black.."AlNsb"..msg.chat_id) then    
Redis:set(black..":"..msg.sender.user_id..":lov_Botttuus"..msg.chat_id,"sendlove")
hggg = '‹ : الان ارسل اسم الشخص :'
LuaTele.sendText(msg_chat_id,msg_id,hggg) 
return false
end
...
if not Redis:get(black.."AlNsb"..msg.chat_id) then    
Redis:set(black..":"..msg.sender.user_id..":krh_Bots"..msg.chat_id,"sendkrhe")
hggg = '‹ : الان ارسل اسمك واسم الشخص الثاني :'
LuaTele.sendText(msg_chat_id,msg_id,hggg) 
return false
end
...
if not Redis:get(black.."AlNsb"..msg.chat_id) then    
Redis:set(black..":"..msg.sender.user_id..":rjo_Bots"..msg.chat_id,"sendrjoe")
hggg = '‹ : الان ارسل اسم الشخص :'
LuaTele.sendText(msg_chat_id,msg_id,hggg) 
return false
end
...
if not Redis:get(black.."AlNsb"..msg.chat_id) then    
Redis:set(black..":"..msg.sender.user_id..":ano_Bots"..msg.chat_id,"sendanoe")
hggg = '‹ : الان ارسل اسم الشخص :'
LuaTele.sendText(msg_chat_id,msg_id,hggg) 
return false
end
...
if Redis:get(black..'AlNsb'..msg.chat_id)  then
return LuaTele.sendText(msg_chat_id,msg_id,'‹ : تم تعطيل النسب مسبقا\n ✓',"md")
else
Redis:set(black.."AlNsb"..msg.chat_id,"true")
...
Redis:del(black.."AlNsb"..msg.chat_id)
...
if Redis:get(black..'myphoto'..msg.chat_id)  then
return LuaTele.sendText(msg_chat_id,msg_id,'‹ : تم تعطيل صورتي مسبقا\n ✓',"md")
else
Redis:set(black.."myphoto"..msg.chat_id,"off")
...
if not Redis:get(black..'myphoto'..msg.chat_id)  then
return LuaTele.sendText(msg_chat_id,msg_id,'‹ : تم تفعيل صورتي مسبقا\n ✓',"md")
else
Redis:del(black.."myphoto"..msg.chat_id)
...
Redis:set(black.."black:Set:Id:Group"..msg.chat_id,Text_Rand)
...
Redis:srem(black.."black:TheBasicsW:Group"..msg_chat_id,UserId[2]) 
...
{
{text = '. ‹ 𝖻𝗅𝖺𝖼𝗄 𝖳𝖾𝖺𝗆 . ',url="t.me/JFFFFF"}
},
{
...
if text == "ميمز" then
Abs = math.random(2,140); 
local Text =" [متحركات Gٍٓif ᯓ ](t.me/JFFFFF)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '. ‹ 𝖻𝗅𝖺𝖼𝗄 𝖳𝖾𝖺𝗆 . ',url="t.me/JFFFFF"}},
}
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. msg.chat_id .. '&voice=https://t.me/https://t.me/JFFFFF/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboardd.inline_keyboard = {
{
{text = '❲ 𝗎𝗉𝖽𝖺𝗍𝖾’s ❳', url = "https://t.me/JFFFFF"}
},
{
{text = '- 𝖻𝗅𝖺𝖼𝗄  𝖲𝗈𝗎𝗋𝖼𝖾 .', url='https://t.me/JFFFFF'},
},
}
local msg_id = msg.id/2097152/0.5 
return https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
{{text = 'Delete Instagram',url="https://www.instagram.com/accounts/login/?next=/accounts/remove/request/permanent/"},{text = 'Delete snapchat',url="https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.blackchat.com%2Faccounts%2Fdeleteaccount"}},{{text= ' سورس الروكس ',url="t.me/JFFFFF"}}
}
local msg_id = msg.id/2097152/0.5
...
keyboard.inline_keyboard = {
{
{text = '𝗎𝗉𝖽𝖺𝗍𝖾𝗌', url = 'https://t.me/JFFFFF'},{text = '. ‹ 𝖻𝗅𝖺𝖼𝗄 𝖳𝖾𝖺𝗆', url = 'https://t.me/JFFFFF'}, 
},
{
{text = 'مبࢪمج اݪسوࢪس', url = 't.me/X_GGX'}, 
},
}
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id=' .. msg.chat_id .. '&photo=https://t.me/JFFFFF&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == "منو اني" then
if msg.sender.user_id == tonumber(798700870) then
...
if text and Redis:get(black.."addchannel"..msg.sender.user_id) == "on" then
Redis:set(black.."chadmin"..msg_chat_id,text) 
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(black.."chadmin"..msg_chat_id),"md",true)  
end
...
Redis:set(black.."black:Lock:phshar"..msg_chat_id,true) 
...
Redis:del(black.."black:Lock:phshar"..msg_chat_id)  
...
Redis:del(black.."black:TheBasicsQ:Group"..msg_chat_id) 
...
if text == (Redis:get(black.."black:Name:Bot") or "الروكس") then
local NamesBot = (Redis:get(black.."black:Name:Bot") or "الروكس")
local NameBots = {
"يروح "..NamesBot.. " كول؟",
"انا "..NamesBot.. " القميل",
"هاعمري",
...
keyboard.inline_keyboard = {
{
{text = NamesBots, url = 'https://t.me/JFFFFF'}, 
},
{
...
if text == "بوسه" then
local NamesBot = (Redis:get(black.."black:Name:Bot") or "black")
local BotName = {
"اهممممواح🙈😉.",
"عيع خدك وصخ 😹🏃‍♀️.",
"اوفف اخدر اذاابوسه 🙈😻.",
...
local bank_users = Redis:smembers(black.."zrfffidtf")
...
local mony = Redis:get(black.."zrffdcf"..v) or 0
...
if num <= 25 then
fne = Redis:get(black..':toob:Name:'..v[2])
tt =  "["..fne.."]("..fne..")"
local mony = v[1]
local emo = emoji[k]
num = num + 1
...
ballancee = Redis:get(black.."nool:flotysb"..msg.sender.user_id) or 0
local bank_users = Redis:smembers(black.."ttpppi")
if #bank_users == 0 then
...
mony_list = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(black.."nool:flotysb"..v) or 0
table.insert(mony_list, {tonumber(mony) , v})
end
table.sort(mony_list, function(a, b) return a[1] > b[1] end)
num = 1
...
local bank_users = Redis:smembers(black.."almtzog"..msg_chat_id)
if #bank_users == 0 then
...
mony_list = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(black.."mznom"..msg_chat_id..v) 
table.insert(mony_list, {tonumber(mony) , v})
end
table.sort(mony_list, function(a, b) return a[1] > b[1] end)
num = 1
...
for k,v in pairs(mony_list) do
if num <= 10 then
local zwga_id = Redis:get(black..msg_chat_id..v[2].."rgalll2:")
local user_name = LuaTele.getUser(v[2]).first_name
fne = Redis:get(black..':toob:Name:'..zwga_id)
fnte = Redis:get(black..':toob:Name:'..v[2])
...
if Redis:get(black..msg_chat_id..msg.sender.user_id.."rgalll2:") then
local zwga_id = Redis:get(black..msg_chat_id..msg.sender.user_id.."rgalll2:") 
local zoog2 = Redis:get(black..msg_chat_id..msg.sender.user_id.."rgalll2:") 
local albnt = LuaTele.getUser(zoog2)
fne = Redis:get(black..':toob:Name:'..zoog2)
albnt = "["..fne.."](tg://user?id="..zoog2..") "
return LuaTele.sendText(msg_chat_id,msg_id,"• الحق ي : "..albnt.." زوجك يبي يتزوج ","md")
end
if Redis:get(black..msg_chat_id..msg.sender.user_id.."bnttt2:") then
local zwga_id = Redis:get(black..msg_chat_id..msg.sender.user_id.."bnttt2:") 
local zoog2 = Redis:get(black..msg_chat_id..zwga_id.."rgalll2:") 
...
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
if Redis:get(black..msg_chat_id..Message_Reply.sender.user_id.."rgalll2:") or Redis:get(black..msg_chat_id..Message_Reply.sender.user_id.."bnttt2:") then
...
local zwga_id = Redis:get(black..msg_chat_id..msg.sender.user_id.."bnttt2:") 
Redis:set(black..msg_chat_id..Message_Reply.sender.user_id.."bnttt2:", msg.sender.user_id)
Redis:set(black..msg_chat_id..msg.sender.user_id.."rgalll2:", Message_Reply.sender.user_id)
Redis:set(black..msg_chat_id..Message_Reply.sender.user_id.."mhrrr2:", UserNameyy)
Redis:set(black..msg_chat_id..msg.sender.user_id.."mhrrr2:", UserNameyy)
...
Redis:decrby(black.."nool:flotysb"..msg.sender.user_id , UserNameyy)
Redis:incrby(black.."nool:flotysb"..Message_Reply.sender.user_id , UserNameyy)
Redis:incrby(black.."mznom"..msg_chat_id..msg.sender.user_id , UserNameyy)
Redis:sadd(black.."almtzog"..msg_chat_id,msg.sender.user_id)
...
if text == "زواجي" then
if not Redis:get(black..msg_chat_id..msg.sender.user_id.."rgalll2:") and not Redis:get(black..msg_chat_id..msg.sender.user_id.."bnttt2:") then
return LuaTele.sendText(msg_chat_id,msg_id,"انت اعزب","md")
end
if Redis:get(black..msg_chat_id..msg.sender.user_id.."bnttt2:") then
local zwga_id = Redis:get(black..msg_chat_id..msg.sender.user_id.."rgalll2:") 
local zoog2 = Redis:get(black..msg_chat_id..zwga_id.."rgalll2:") 
local mhrr = Redis:get(black..msg_chat_id..msg.sender.user_id.."mhrrr2:")
local id_rgal = LuaTele.getUser(zwga_id)
fne = Redis:get(black..':toob:Name:'..zwga_id)
alzog = "["..fne.."](tg://user?id="..zwga_id..") "
local albnt = LuaTele.getUser(zoog2)
fnte = Redis:get(black..':toob:Name:'..zoog2)
albnt = "["..fnte.."](tg://user?id="..zoog2..") "
return LuaTele.sendText(msg_chat_id,msg_id,"• عقد زواجكم\n• الزوج : "..alzog.."\n• الزوجه : "..albnt.." \n• المهر : "..mhrr.." دولار ","md")
end
if Redis:get(black..msg_chat_id..msg.sender.user_id.."rgalll2:") then
local zwga_id = Redis:get(black..msg_chat_id..msg.sender.user_id.."rgalll2:") 
local zoog2 = Redis:get(black..msg_chat_id..zwga_id.."bnttt2:") 
local mhrr = Redis:get(black..msg_chat_id..msg.sender.user_id.."mhrrr2:")
local id_rgal = LuaTele.getUser(zwga_id)
fnte = Redis:get(black..':toob:Name:'..zwga_id)
albnt = "["..fnte.."](tg://user?id="..zwga_id..") "
local gg = LuaTele.getUser(zoog2)
fntey = Redis:get(black..':toob:Name:'..zoog2)
...
if Redis:sismember(black.."noooybgy",yemsg.sender.user_id) then
cccc = Redis:get(black.."noolb"..yemsg.sender.user_id)
gg = Redis:get(black.."nnonb"..yemsg.sender.user_id)
uuuu = Redis:get(black.."nnonbn"..yemsg.sender.user_id)
pppp = Redis:get(black.."zrffdcf"..yemsg.sender.user_id) or 0
ballancee = Redis:get(black.."nool:flotysb"..yemsg.sender.user_id) or 0
...
if text == "خلع" then
if not Redis:get(black..msg_chat_id..msg.sender.user_id.."bnttt2:") then
...
alzog = " "..gg.first_name.." "
local zwga_id = Redis:get(black..msg_chat_id..msg.sender.user_id.."bnttt2:") 
Redis:incrby(black.."nool:flotysb"..zwga_id,mhrr)
Redis:decrby(black.."nool:flotysb"..msg.sender.user_id,mhrr)
Redis:del(black.."mznom"..msg_chat_id..zwga_id)
Redis:srem(black.."almtzog"..msg_chat_id,zwga_id)
Redis:del(black.."mznom"..msg_chat_id..msg.sender.user_id)
Redis:srem(black.."almtzog"..msg_chat_id,msg.sender.user_id)
Redis:del(black..msg_chat_id..msg.sender.user_id.."mhrrr2:")
Redis:del(black..msg_chat_id..zwga_id.."mhrrr2:")
Redis:del(black..msg_chat_id..msg.sender.user_id.."bnttt2:")
Redis:del(black..msg_chat_id..zwga_id.."bnttt2:")
Redis:del(black..msg_chat_id..msg.sender.user_id.."rgalll2:")
Redis:del(black..msg_chat_id..zwga_id.."rgalll2:")
LuaTele.sendText(msg_chat_id,msg_id,"• تم خلعت زوجك "..alzog.." \n ورجعت له "..mhrr.." دولار","md")
end
if text == "طلاق"  then
if not Redis:get(black..msg_chat_id..msg.sender.user_id.."rgalll2:") then
...
balas = 0
if Redis:sismember(black.."noooybgy",msg.sender.user_id) then
return LuaTele.sendText(msg.chat_id,msg.id, "• لديك حساب بنكي مسبقاً\n\n• لعرض معلومات حسابك اكتب\n↤︎ `حسابي`","md",true)
end
Redis:setex(black.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id,60, true)
...
if Redis:get(black.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id) then
...
gg = "والت كارد ."
flossst = Redis:get(black.."nool:flotysb"..msg.sender.user_id) or 0
local banid = msg.sender.user_id
Redis:set(black.."nonna"..msg.sender.user_id,news)
Redis:set(black.."noolb"..msg.sender.user_id,creditcc)
Redis:set(black.."nnonb"..msg.sender.user_id,text)
Redis:set(black.."nnonbn"..msg.sender.user_id,gg)
Redis:set(black.."nonallname"..creditcc,news)
Redis:set(black.."nonallbalc"..creditcc,balas)
Redis:set(black.."nonallcc"..creditcc,creditcc)
Redis:set(black.."nonallban"..creditcc,text)
Redis:set(black.."nonallid"..creditcc,banid)
Redis:sadd(black.."noooybgy",msg.sender.user_id)
Redis:del(black.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id) 
...
local banid = msg.sender.user_id
Redis:set(black.."nonna"..msg.sender.user_id,news)
Redis:set(black.."noolb"..msg.sender.user_id,creditvi)
Redis:set(black.."nnonb"..msg.sender.user_id,text)
Redis:set(black.."nnonbn"..msg.sender.user_id,gg)
Redis:set(black.."nonallname"..creditvi,news)
Redis:set(black.."nonallbalc"..creditvi,balas)
Redis:set(black.."nonallcc"..creditvi,creditvi)
Redis:set(black.."nonallban"..creditvi,text)
Redis:set(black.."nonallid"..creditvi,banid)
Redis:sadd(black.."noooybgy",msg.sender.user_id)
Redis:del(black.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id) 
...
local banid = msg.sender.user_id
Redis:set(black.."nonna"..msg.sender.user_id,news)
Redis:set(black.."noolb"..msg.sender.user_id,creditex)
Redis:set(black.."nnonb"..msg.sender.user_id,text)
Redis:set(black.."nnonbn"..msg.sender.user_id,gg)
Redis:set(black.."nonallname"..creditex,news)
Redis:set(black.."nonallbalc"..creditex,balas)
Redis:set(black.."nonallcc"..creditex,creditex)
Redis:set(black.."nonallban"..creditex,text)
Redis:set(black.."nonallid"..creditex,banid)
Redis:sadd(black.."noooybgy",msg.sender.user_id)
Redis:del(black.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id) 
...
if Redis:sismember(black.."noooybgy",msg.sender.user_id) then
Redis:srem(black.."noooybgy", msg.sender.user_id)
Redis:del(black.."noolb"..msg.sender.user_id)
Redis:del(black.."zrffdcf"..msg.sender.user_id)
Redis:srem(black.."zrfffidtf", msg.sender.user_id)
...
if msg.ControllerBot then
local bank_users = Redis:smembers(black.."noooybgy")
for k,v in pairs(bank_users) do
Redis:del(black.."nool:flotysb"..v)
Redis:del(black.."zrffdcf"..v)
Redis:del(black.."innoo"..v)
Redis:del(black.."nnooooo"..v)
Redis:del(black.."nnoooo"..v)
Redis:del(black.."nnooo"..v)
Redis:del(black.."nnoo"..v)
Redis:del(black.."polic"..v)
Redis:del(black.."ashmvm"..v)
Redis:del(black.."hrame"..v)
Redis:del(black.."test:mmtlkat6"..v)
Redis:del(black.."zahbmm2"..v)
end
Redis:del(black.."ttpppi")
...
ballanceed = Redis:get(black.."nool:flotysb"..Remsg.sender.user_id) or 0
...
if Redis:sismember(black.."noooybgy",msg.sender.user_id) then
cccc = Redis:get(black.."noolb"..msg.sender.user_id)
gg = Redis:get(black.."nnonb"..msg.sender.user_id)
uuuu = Redis:get(black.."nnonbn"..msg.sender.user_id)
pppp = Redis:get(black.."zrffdcf"..msg.sender.user_id) or 0
ballancee = Redis:get(black.."nool:flotysb"..msg.sender.user_id) or 0
LuaTele.sendText(msg.chat_id,msg.id, "• الاسم ↢ "..news.."\n• الحساب ↢ `"..cccc.."`\n• بنك ↢ ( "..gg.." )\n• نوع ↢ ( "..uuuu.." )\n• الرصيد ↢ ( "..ballancee.." دولار 💸 )\n• الزرف ( "..pppp.." دولار 💸 )\n-","md",true)
else
LuaTele.sendText(msg.chat_id,msg.id, "• ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
...
if text == 'مضاربه' then
if Redis:get(black.."nnooooo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(black.."nnooooo" .. msg.sender.user_id)
rr = oger(check_time)
...
Redis:decrby(black.."nool:flotysb"..msg.sender.user_id , ballanceekku)
Redis:setex(black.."nnooooo" .. msg.sender.user_id,1200, true)
...
ballanceekku = math.floor(coniss / 100 * modarbaa)
ballanceekkku = math.floor(ballancee + ballanceekku)
Redis:incrby(black.."nool:flotysb"..msg.sender.user_id , math.floor(ballanceekku))
Redis:setex(black.."nnooooo" .. msg.sender.user_id,1200, true)
...
if Redis:get(black.."nnoooo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(black.."nnoooo" .. msg.sender.user_id)
rr = oger(check_time)
...
if Redis:get(black.."xxxr" .. msg.sender.user_id) then
ballanceekk = math.floor(coniss / 100 * 10)
ballanceekkk = math.floor(ballancee + ballanceekk)
Redis:incrby(black.."nool:flotysb"..msg.sender.user_id , math.floor(ballanceekk))
Redis:sadd(black.."ttpppi",msg.sender.user_id)
Redis:setex(black.."nnoooo" .. msg.sender.user_id,1200, true)
...
Redis:del(black.."nool:flotysb"..msg.sender.user_id)
...
if text == 'حظ' then
if Redis:get(black.."nnooo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(black.."nnooo" .. msg.sender.user_id)
rr = oger(check_time)
...
Redis:incrby(black.."nool:flotysb"..msg.sender.user_id , math.floor(ballanceek))
Redis:setex(black.."nnooo" .. msg.sender.user_id,200, true)
...
ff = Redis:get(black.."nool:flotysb"..msg.sender.user_id)
...
Redis:decrby(black.."nool:flotysb"..msg.sender.user_id , coniss)
Redis:setex(black.."nnooo" .. msg.sender.user_id,200, true)
ff = Redis:get(black.."nool:flotysb"..msg.sender.user_id) or 0
...
Redis:set('black:'..bot_id..'idgem:user'..msg.chat_id_,taha)  
Redis:setex('black:'..bot_id.."gemadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
Redis:incrby('black:'..bot_id..'add:F'..msg.chat_id_..result.sender_user_id_,F)  
Redis:incrby('black:'..bot_id..'add:Fall'..msg.chat_id_..result.sender_user_id_,F)  
...
local coniss = coniss:gsub('٩','9')
local coniss = tonumber(coniss)
if not Redis:sismember(black.."noooybgy",msg.sender.user_id) then
return LuaTele.sendText(msg.chat_id,msg.id, "• ماعندك حساب بنكي ","md",true)
end
if Redis:get(black.."polici" .. msg.sender.user_id) then  
local check_time = Redis:ttl(black.."polici" .. msg.sender.user_id)
rr = oger(check_time)
...
if Redis:get(black.."nonallcc"..text) then
...
local fsvhhh = Redis:get(black.."nonallid"..text)
local bann = LuaTele.getUser(fsvhhh)
hsabe = Redis:get(black.."nnonb"..fsvhhh)
nouu = Redis:get(black.."nnonbn"..fsvhhh)
...
if Redis:get(black.."hramep" .. UserNameyr) then  
local check_time = Redis:ttl(black.."hramep" .. UserNameyr)
rr = oger(check_time)
...
Redis:incrby(black.."nool:flotysb"..fsvhhh ,UserNameyy)
Redis:decrby(black.."nool:flotysb"..msg.sender.user_id ,UserNamey)
Redis:setex(black.."polici" .. msg.sender.user_id,600, true)
Redis:setex(black.."hramep" ..UserNamey ,600, true)
...
ballancee = Redis:get(black.."nool:flotysb"..bl) or 0
Redis:decrby(black.."nool:flotysb"..bl , ballancee)
LuaTele.sendText(msg.chat_id,msg.id, "*تم تصفيرة بنجاح !*","md",true)
end

if text == 'قرض' or text == 'قرض' then
if Redis:sismember(black.."noooybgy",msg.sender.user_id) then
if Redis:get(black.."nnoo1" .. msg.sender.user_id) then  
local check_time = Redis:ttl(black.."nnoo1" .. msg.sender.user_id)
rr = oger(check_time)
return LuaTele.sendText(msg.chat_id, msg.id,"• من شوي عطيتك انتظر "..rr.." دقيقة") 
end
if Redis:get(black.."xxxr" .. msg.sender.user_id) then
Redis:incrby(black.."nool:flotysb"..msg.sender.user_id , 1000000)
Redis:sadd(black.."ttpppi",msg.sender.user_id)
return LuaTele.sendText(msg.chat_id,msg.id,"• خذ قرض 1000000 دولار 💸","md",true)
end
local jjjo = "6000000"
Redis:incrby(black.."nool:flotysb"..msg.sender.user_id , jjjo)
Redis:sadd(black.."ttpppi",msg.sender.user_id)
LuaTele.sendText(msg.chat_id,msg.id,"• خذ ي مطفر "..jjjo.." دولار 💸","md",true)
Redis:setex(black.."nnoo1" .. msg.sender.user_id,600, true)
else
LuaTele.sendText(msg.chat_id,msg.id, "• ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
...
if Redis:sismember(black.."noooybgy",msg.sender.user_id) then
if Redis:get(black.."nnoo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(black.."nnoo" .. msg.sender.user_id)
rr = oger(check_time)
return LuaTele.sendText(msg.chat_id, msg.id,"• من شوي عطيتك انتظر "..rr.." دقيقة") 
end
if Redis:get(black.."xxxr" .. msg.sender.user_id) then
Redis:incrby(black.."nool:flotysb"..msg.sender.user_id , 3000)
Redis:sadd(black.."ttpppi",msg.sender.user_id)
...
Redis:sadd(black.."ttpppi",msg.sender.user_id)
LuaTele.sendText(msg.chat_id,msg.id,"• خذ ي مطفر "..jjjo.." دولار 💸","md",true)
Redis:setex(black.."nnoo" .. msg.sender.user_id,600, true)
else
LuaTele.sendText(msg.chat_id,msg.id, "• ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
...
if Redis:sismember(black.."noooybgy",UserId_Info.id) then
ballanceed = Redis:get(black.."nool:flotysb"..UserId_Info.id) or 0
LuaTele.sendText(msg.chat_id,msg.id, "• فلوسه "..ballanceed.." دولار 💸","md",true)
else
...
local check_time = Redis:ttl(black.."polic" .. msg.sender.user_id)
rr = oger(check_time)
...
local check_time = Redis:ttl(black.."hrame" .. Remsg.sender.user_id)
rr = oger(check_time)
return LuaTele.sendText(msg.chat_id, msg.id,"• زارفينه قبلك \n• يمديك تزرفه بعد "..rr.." دقيقة") 
end 
if Redis:sismember(black.."noooybgy",Remsg.sender.user_id) then
ballanceed = Redis:get(black.."nool:flotysb"..Remsg.sender.user_id) or 0
...
local ballanceed = Redis:get(black.."nool:flotysb"..Remsg.sender.user_id) or 0
Redis:incrby(black.."nool:flotysb"..msg.sender.user_id , hrame)
Redis:decrby(black.."nool:flotysb"..Remsg.sender.user_id , hrame)
Redis:sadd(black.."ttpppi",msg.sender.user_id)
Redis:setex(black.."hrame" .. Remsg.sender.user_id,900, true)
Redis:incrby(black.."zrffdcf"..msg.sender.user_id,hrame)
Redis:sadd(black.."zrfffidtf",msg.sender.user_id)
...
Redis:incrby(black.."nool:flotysb"..msg.sender.user_id , F)
local ballancee = Redis:get(black.."nool:flotysb"..msg.sender.user_id) or 0
...
Redis:setex(black.."innoo" .. msg.sender.user_id,600, true)
end
if text == 'راتب' or text == 'راتبي' then
if Redis:sismember(black.."noooybgy",msg.sender.user_id) then
if Redis:get(black.."innoo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(black.."innoo" .. msg.sender.user_id)
rr = oger(check_time)
...
local CmdStart = '*\n‹ : اهلا بك عزيزي في بوت '..(Redis:get(black.."black:Name:Bot") or "black")..
...
{
{text = '‹ : شࢪوحات السوࢪس -', url = 't.me/JFFFFF'},
},
{
{text = '‹ : سۅࢪس الروكس -', url = 't.me/JFFFFF'},
},
}
}
...
{
{text = '‹ : شࢪوحات السوࢪس', url = 't.me/JFFFFF'}, {text = '‹ : شراء بوت', url = 't.me/X_GGX'},
},
{
{text = '‹ : . ‹ 𝖻𝗅𝖺𝖼𝗄 𝖳𝖾𝖺𝗆 .', url = 't.me/JFFFFF'},
},
...
local Get_Chat = LuaTele.getChat(ChatId)
local GetLink = Redis:get(black.."black:Group:Link"..ChatId) 
if GetLink then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {
{
...
keyboard.inline_keyboard = {
{
{text = '❲ ‹ 𝖲𝗈𝗎𝗋𝖼𝖾 𝖻𝗅𝖺𝖼𝗄 . ❳',url="https://t.me/JFFFFF"},{text = ' Updates source ⁦ᯓ',url="https://t.me/JFFFFF"}
},
{
...
{
{text = '❲ ‹ 𝖻𝗅𝖺𝖼𝗄 𝖲𝗈𝗎𝗋𝖼𝖾 ❳',url="t.me/JFFFFF"}
},
}
local msg_id = Msg_id/2097152/0.5
...
{
{text = '𝖲𝗈𝗎𝗋𝖼𝖾 ‹ 𝖻𝗅𝖺𝖼𝗄:',url="t.me/JFFFFF"}
},
}
local msg_id = Msg_id/2097152/0.5
...
Redis:set(black.."black:Get:Reides:Commands:Group"..UserId[2]..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(black.."black:Get:Reides:Commands:Group"..UserId[2]..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(black.."black:Get:Reides:Commands:Group"..UserId[2]..":"..'ا','ايدي')
Redis:set(black.."black:Get:Reides:Commands:Group"..UserId[2]..":"..'م','رفع مميز')
Redis:set(black.."black:Get:Reides:Commands:Group"..UserId[2]..":"..'اد', 'رفع ادمن')
Redis:set(black.."black:Get:Reides:Commands:Group"..UserId[2]..":"..'مد','رفع مدير')
Redis:set(black.."black:Get:Reides:Commands:Group"..UserId[2]..":"..'من', 'رفع منشئ')
Redis:set(black.."black:Get:Reides:Commands:Group"..UserId[2]..":"..'اس', 'رفع منشئ اساسي')
Redis:set(black.."black:Get:Reides:Commands:Group"..UserId[2]..":"..'مط','رفع مطور')
Redis:set(black.."black:Get:Reides:Commands:Group"..UserId[2]..":"..'تك','تنزيل الكل')
Redis:set(black.."black:Get:Reides:Commands:Group"..UserId[2]..":"..'ر','الرابط')
Redis:set(black.."black:Get:Reides:Commands:Group"..UserId[2]..":"..'رر','ردود المدير')
Redis:set(black.."black:Get:Reides:Commands:Group"..UserId[2]..":"..'،،','مسح المكتومين')
Redis:set(black.."black:Get:Reides:Commands:Group"..UserId[2]..":"..'رد','اضف رد')
Redis:set(black.."black:Get:Reides:Commands:Group"..UserId[2]..":"..'سح','مسح سحكاتي')
Redis:set(black.."black:Get:Reides:Commands:Group"..UserId[2]..":"..'غ','غنيلي')
Redis:set(black.."black:Get:Reides:Commands:Group"..UserId[2]..":"..'رس','رسائلي')
Redis:set(black.."black:Get:Reides:Commands:Group"..UserId[2]..":"..'ثانوي','رفع مطور ثانوي')
...
local bank_users = Redis:smembers(black.."almtzog"..ChatId)
top_mony = "توب اغنى 10 زوجات بالقروب :\n\n"
mony_list = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(black.."mznom"..ChatId..v)
table.insert(mony_list, {tonumber(mony) , v})
end
table.sort(mony_list, function(a, b) return a[1] > b[1] end)
num = 1
...
for k,v in pairs(mony_list) do
if num <= 10 then
local zwga_id = Redis:get(black..ChatId..v[2].."rgalll2:")
local user_name = LuaTele.getUser(v[2]).first_name
local user_nambe = LuaTele.getUser(zwga_id).first_name
...
ballancee = Redis:get(black.."zrffdcf"..IdUser) or 0
local bank_users = Redis:smembers(black.."zrfffidtf")
top_mony = "توب اكثر 25 شخص حرامية فلوس:\n\n"
mony_list = {}
for k,v in pairs(bank_users) do
...
ballancee = Redis:get(black.."nool:flotysb"..IdUser) or 0
local bank_users = Redis:smembers(black.."ttpppi")
top_mony = "توب اغنى 25 شخص :\n\n"
mony_list = {}
for k,v in pairs(bank_users) do
