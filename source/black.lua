------------------------------------------------
-- This Source Was Developed By (black) @PPPPPE.--
...
Redis:del(black.."black:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(black.."black:Set:Id:Groups"..msg.chat_id,text:match("(.*)"))
...
download('https://raw.githubusercontent.com/MaLaTH-M/black/main/black.lua','black.lua')
...
if TextMsg == 'صورتي' then
Redis:del(black.."black:Status:photo"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙ تم تعطيل صورتي ","md",true)
end
if TextMsg == 'قول' then
Redis:del(black.."black:Status:kool"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙ تم تعطيل امر قول ","md",true)
end
if TextMsg == 'جمالي' then
Redis:del(black.."black:Status:gamle"..msg_chat_id) 
...
Redis:setex(black.."black:Set:Id:Groups"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
 ᥀︙ ارسل الان النص
 ᥀︙ يمكنك اضافه :
...
if not Redis:get(black.."black:Status:gamle"..msg_chat_id) then
return false
end
local ban = LuaTele.getUser(msg.sender.user_id)
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
...
if Redis:get(black.."black:Status:kool"..msg.chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,m,"md",true) 
end
end
if text == "صورتي" then
if Redis:get(black.."black:Status:photo"..msg.chat_id) then
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
local ban = LuaTele.getUser(msg.sender.user_id)
...
if text == (Redis:get(black.."black:Name:Bot") or "بلاك بينك") then
local NamesBot = (Redis:get(black.."black:Name:Bot") or "بلاك بينك")
local NameBots = {
"ها "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
...
local CmdStart = '*\n᥀︙أهلآ بك في بوت '..(Redis:get(black.."black:Name:Bot") or "بلاك بينك")..
