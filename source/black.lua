...
if Redis:get(Theblack.."black:Lock:Audio"..ChatId) == "del" then
lock_muse = "✓"
elseif Redis:get(Theblack.."black:Lock:Audio"..ChatId) == "ked" then 
lock_muse = "بالتقيد "    
elseif Redis:get(Theblack.."black:Lock:Audio"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(Theblack.."black:Lock:Audio"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "✗ "    
end 
...
if Redis:sismember(Theblack.."black:TheBasics:Group"..chat,useri)  then
TheBasicsz = "✓"
else
TheBasicsz = "✗"
end
if Redis:sismember(Theblack.."black:Originators:Group"..chat,useri) then
Originatorsz = "✓"
else
Originatorsz = "✗"
end
if Redis:sismember(Theblack.."black:Managers:Group"..chat,useri) then
Managersz = "✓"
else
Managersz = "✗"
end
if Redis:sismember(Theblack.."black:Addictive:Group"..chat,useri) then
Addictivez = "✓"
else
Addictivez = "✗"
end
if Redis:sismember(Theblack.."black:Distinguished:Group"..chat,useri) then
Distinguishedz = "✓"
else
Distinguishedz = "✗"
end
...
if Redis:sismember(Theblack.."chatMemberStatusRestricted"..chat,useri) then
Restricted = "✓"
else
Restricted = "✗"
end
if Redis:sismember(Theblack.."BanGroup"..chat,useri) then
BanGroup = "✓"
else
BanGroup = "✗"
end
if Redis:sismember(Theblack.."SilentGroup:Group"..chat,useri) then
SilentGroup = "✓"
else
SilentGroup = "✗"
end
...
elseif tonumber(msg.sender.user_id) == 80769797 then
...
if Redis:get(Theblack.."black:Lock:Taf"..msg_chat_id) and not msg.Addictive then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
...
if Redis:get(Theblack.."black:Lock:Kfr"..msg_chat_id) and not msg.Addictive then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
...
if Redis:get(Theblack.."black:Lock:F1arsi"..msg_chat_id) and not msg.Addictive then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
...
local N = (Redis:get(Theblack.."Name:Bot") or "بلاك")
...
if Redis:get(Theblack.."black:Game:black1"..msg.chat_id) then
if text == Redis:get(Theblack.."black:Game:black1"..msg.chat_id) then 
Redis:del(Theblack.."black:Game:black1"..msg.chat_id)
Redis:incrby(Theblack.."black:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if chat_type(msg_chat_id) == "GroupBot" and Redis:sismember(Theblack.."black:ChekBotAdd",msg_chat_id) then
Redis:incr(Theblack..'black:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) 

if text then
local GetMsg = Redis:incr(Theblack..'black:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) 
Redis:hset(Theblack..':GroupUserCountMsg:'..msg_chat_id,msg.sender.user_id,GetMsg)
local UserInfo = LuaTele.getUser(msg.sender.user_id) 
if UserInfo.first_name then
NameLUser = UserInfo.first_name
else
...
NameLUser = NameLUser:gsub("]","")
NameLUser = NameLUser:gsub("[[]","")
Redis:hset(Theblack..':GroupNameUser:'..msg_chat_id,msg.sender.user_id,NameLUser)
end
...
GroupAllRtba = Redis:hgetall(Theblack..':GroupUserCountMsg:'..msg.chat_id)
GetAllNames  = Redis:hgetall(Theblack..':GroupNameUser:'..msg.chat_id)
GroupAllRtbaL = {}
...
GroupAllRtba = Redis:hgetall(Theblack..':GroupUserCountMsg:groups')
GetAllNames  = Redis:hgetall(Theblack..':GroupNameUser:groups')
GroupAllRtbaL = {}
for k,v in pairs(GroupAllRtba) do table.insert(GroupAllRtbaL,{v,k}) end
Count,Kount,i = 8 , 0 , 1
for _ in pairs(GroupAllRtbaL) do Kount = Kount + 1 end
...
local GetMsg = Redis:incr(Theblack..'Theblack:MsgNumbergroups'..msg_chat_id) or 1
Redis:hset(Theblack..':GroupUserCountMsg:groups',msg_chat_id,GetMsg)
end
...
local BIO = '⌔ :Bio -› '..getbio(msg.sender.user_id)
if photo.total_count > 0 then
data = {} 
...
Redis:sadd(Theblack.."black:allM"..msg.chat_id, msg.id)
if Redis:get(Theblack.."black:Status:Del:Media"..msg.chat_id) then    
local Numbardel = Redis:get(Theblack.."allM:numdel"..msg.chat_id) or 200
local gmedia = Redis:scard(Theblack.."black:allM"..msg.chat_id)  
...
Redis:set(Theblack.."allM:numdel"..msg.chat_id,Numbardel) 
...
data = {
{
{text = 'التالي', data = msg.sender.user_id..'/'..'alib1'}
},
}}
...
{{text = 'Delete Instagram',url="https://www.instagram.com/accounts/login/?next=/accounts/remove/request/permanent/"},{text = 'Delete snapchat',url="https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.blackchat.com%2Faccounts%2Fdeleteaccount"}},{{text= ' سورس بلاك ',url="t.me/JFFFFF"}}
}
local msg_id = msg.id/2097152/0.5
...
Redis:del(Theblack.."black:Lock:Bot:kick"..msg_chat_id)
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⌔ : تم فتح البوتات بالطرد").unLock,"md",true)  
return false
end 
...
if ChannelJoin(msg) == false then
local Get_Chat = LuaTele.getChat(Redis:get(Theblack..'black:ChanneliD:Join'))
local NcH = (Redis:get(Theblack.."black:CH:Bot") or Get_Chat.title)
local NcHlink = (Redis:get(Theblack.."black:CHlink:Bot") or "⌁ : عذراً لاتستطيع استخدام البوت !\n⌁ : عليك الاشتراك في القناة اولاً :")
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(Theblack..'black:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(Theblack.."black:Lock:Taf"..msg_chat_id,true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(Theblack..'black:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(Theblack.."black:Lock:Kfr"..msg_chat_id,true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(Theblack..'black:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(Theblack.."black:Lock:F1arsi"..msg_chat_id,true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(Theblack..'black:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end 
Redis:del(Theblack.."black:Lock:F1arsi"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(Theblack..'black:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end 
Redis:del(Theblack.."black:Lock:Kfr"..msg_chat_id)  
...
{
{text = '«• تحكم الازعاج•» ', data = msg.sender.user_id..'/sting//'..UserId_Info.id},
},
}
}
...
{
{text = '«• تحكم لازعاج •» ', data = msg.sender.user_id..'/sting//'..Message_Reply.sender.user_id}, 
},
}
}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n‹ : الـيـك قـائـمـة الـتـحـكم عـلـي الـعـضـو*',"md",false, false, false, false, reply_markup)
...
{
{text = GetSetieng(msg_chat_id).lock_muse, data = '&'},{text = 'الاغاني : ', data =msg.sender.user_id..'/'.. 'Status_audio'},
},
{
...
data = {
{
{text = ' - 1', data = msg.sender.user_id..'/help1'}, {text = '- 2', data = msg.sender.user_id..'/help2'}, {text = '- 3', data = msg.sender.user_id..'/help3'},
},
{
{text = '- 4', data = msg.sender.user_id..'/help4'}, {text = '- 5', data = msg.sender.user_id..'/help5'}, {text = '- 6', data = msg.sender.user_id..'/help7'},
},
{
{text = '- 7', data = msg.sender.user_id..'/NoNextSeting'}, {text = '- 8', data = msg.sender.user_id..'/listallAddorrem'}, 
},
{
{text = 'إخفاء الأمر', data = msg.sender.user_id..'/delAmr'},
},
...
if Redis:get(Theblack..'BLACKK'..msg.chat_id)  then
return LuaTele.sendText(msg_chat_id,msg_id,'‹ : تم تعطيل الردود مسبقا\n ✓',"md")
else
Redis:set(Theblack.."BLACKK"..msg.chat_id,"off")
return LuaTele.sendText(msg_chat_id,msg_id,'‹ : تم تعطيل الردود\n ✓',"md")
end
end
...
if not Redis:get(Theblack..'BLACKK'..msg.chat_id)  then
return LuaTele.sendText(msg_chat_id,msg_id,'‹ : تم تفعيل الردود مسبقا\n ✓',"md")
else
Redis:del(Theblack.."BLACKK"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,'‹ : تم تفعيل الردود\n ✓',"md")
end
end
...
‹ : زرف او قط او سرقه ↢ تسرق فلوس اشخاص كل ١٠ دقايق
...
if Redis:get(Theblack.."xxxr" .. msg.sender.user_id) then
Redis:incrby(Theblack.."nool:flotysb"..msg.sender.user_id , 10000)
Redis:sadd(Theblack.."ttpppi",msg.sender.user_id)
return LuaTele.sendText(msg.chat_id,msg.id,"• خذ قرض 10000 دولار 💸","md",true)
end
local jjjo = "600000"
...
if text == "الحلفي" then
LuaTele.sendText(msg.chat_id,msg.id, "مطوري القميل 💗🦋","md",true)
end
...
Redis:incrby(Theblack.."nool:flotysb"..msg.sender.user_id , modarbaa)
Redis:setex(Theblack.."nnoo" .. msg.sender.user_id,1200, true)
...
if text == 'زرف' or text == 'قط' or text == 'سرقه' or text == 'قطه' and tonumber(msg.reply_to_message_id) ~= 0 then
local Remsg = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
local UserInfo = LuaTele.getUser(Remsg.sender.user_id)
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then
LuaTele.sendText(msg.chat_id,msg.id,"\nيا غبي ذا بوتتتت","md",true)  
...
data = {
{
{text = 'ابدء اللعب', data = msg.sender.user_id..'/mn'},
},
}
}
...
print(name)
Redis:set(Theblack..'black:Game:black1'..msg.chat_id,name)
...
if text == 'روليت' then
if Redis:get(Theblack.."black:Status:Games"..msg.chat_id) then
Redis:del(Theblack..":Number_Add:"..msg.chat_id..msg.sender.user_id) 
Redis:del(Theblack..':List_Rolet:'..msg.chat_id)  
Redis:setex(Theblack..":Start_Rolet:"..msg.chat_id..msg.sender.user_id,3600,true)  
return LuaTele.sendText(msg_chat_id,msg_id, '*‹ :* حسننا لنلعب , ارسل عدد اللاعبين للروليت .',"md")
end
end
if text == 'نعم' and Redis:get(Theblack..":Witting_StartGame:"..msg.chat_id..msg.sender.user_id) then
local list = Redis:smembers(Theblack..':List_Rolet:'..msg.chat_id) 
if #list == 1 then 
...
Redis:incrby(Theblack.."black:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 5)  
Redis:del(Theblack..':List_Rolet:'..msg.chat_id) 
Redis:del(Theblack..":Witting_StartGame:"..msg.chat_id..msg.sender.user_id)
...
if text and text:match("^(%d+)$") and Redis:get(Theblack..":Start_Rolet:"..msg.chat_id..msg.sender.user_id) then  --// استقبال اللعبه الدمبله
if text == "1" then
Text = "*‹ :* لا استطيع بدء اللعبه بلاعب واحد فقط\n"
else
Redis:set(Theblack..":Number_Add:"..msg.chat_id..msg.sender.user_id,text)  
Text = '‹ :تم بدء تسجيل اللسته \n‹ : يرجى ارسال المعرفات \n‹ : الفائز يحصل على (5) مجوهره\n‹ : عدد الاعبين المطلوبه { *'..text..'* } لاعب \n 🏹'
end
Redis:del(Theblack..":Start_Rolet:"..msg.chat_id..msg.sender.user_id)  
return LuaTele.sendText(msg_chat_id,msg_id,Text)    
end
if text and text:match('^(@[%a%d_]+)$') and Redis:get(Theblack..":Number_Add:"..msg.chat_id..msg.sender.user_id) then    --// استقبال الاسماء
if Redis:sismember(Theblack..':List_Rolet:'..msg.chat_id,text) then
return LuaTele.sendText(msg_chat_id,msg_id,'*‹ :* المعرف {['..text..']} موجود اساسا' ,"md")
end
Redis:sadd(Theblack..':List_Rolet:'..msg.chat_id,text)
local CountAdd = Redis:get(Theblack..":Number_Add:"..msg.chat_id..msg.sender.user_id)
local CountAll = Redis:scard(Theblack..':List_Rolet:'..msg.chat_id)
local CountUser = CountAdd - CountAll
if tonumber(CountAll) == tonumber(CountAdd) then 
Redis:del(Theblack..":Number_Add:"..msg.chat_id..msg.sender.user_id) 
Redis:setex(Theblack..":Witting_StartGame:"..msg.chat_id..msg.sender.user_id,1400,true)  
...
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(Theblack.."black:TheBasics:Group"..ChatId,UserId[2]) then
Redis:srem(Theblack.."black:TheBasics:Group"..ChatId,UserId[2])
else
Redis:sadd(Theblack.."black:TheBasics:Group"..ChatId,UserId[2])
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then 
if Redis:sismember(Theblack.."black:Originators:Group"..ChatId,UserId[2]) then
Redis:srem(Theblack.."black:Originators:Group"..ChatId,UserId[2])
else
Redis:sadd(Theblack.."black:Originators:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(Theblack.."black:Managers:Group"..ChatId,UserId[2]) then
Redis:srem(Theblack.."black:Managers:Group"..ChatId,UserId[2])
else
Redis:sadd(Theblack.."black:Managers:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(Theblack.."black:Addictive:Group"..ChatId,UserId[2]) then
Redis:srem(Theblack.."black:Addictive:Group"..ChatId,UserId[2])
else
Redis:sadd(Theblack.."black:Addictive:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(Theblack.."black:Distinguished:Group"..ChatId,UserId[2]) then
Redis:srem(Theblack.."black:Distinguished:Group"..ChatId,UserId[2])
else
Redis:sadd(Theblack.."black:Distinguished:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
if Redis:sismember(Theblack.."SilentGroup:Group"..ChatId,UserId[2]) then
Redis:srem(Theblack.."SilentGroup:Group"..ChatId,UserId[2])
else
Redis:sadd(Theblack.."SilentGroup:Group"..ChatId,UserId[2])
end
return muteUser(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
if Redis:sismember(Theblack.."BanGroup"..ChatId,UserId[2]) then
Redis:srem(Theblack.."BanGroup"..ChatId,UserId[2])
LuaTele.setChatMemberStatus(ChatId,UserId[2],'restricted',{1,1,1,1,1,1,1,1,1})
else
Redis:sadd(Theblack.."BanGroup"..ChatId,UserId[2])
...
if Redis:sismember(Theblack.."Restricted"..ChatId,UserId[2]) then
Redis:srem(Theblack.."Restricted"..ChatId,UserId[2])
else
Redis:sadd(Theblack.."Restricted"..ChatId,UserId[2])
end
return muteUser(ChatId,UserId[1],Msg_id,UserId[2])
end
end
